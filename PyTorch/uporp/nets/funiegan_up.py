...
class UNetDown(nn.Module): #like conv2d in TF implementation
...
class UNetUp(nn.Module): #like deconv2d in TF implementation
...
class GeneratorFunieGANUP(nn.Module):
    """ A 5-layer UNet-based generator as described in the paper
    """
    def __init__(self, in_channels=3, out_channels=3):
        super(GeneratorFunieGANUP, self).__init__()
        # encoding layers
        ...
        # potentially add 3 more conv layers, additional res layers
        # decoding layers
    ...
    def __init__(self, in_channels=3):
        ...
        self.model = nn.Sequential(
            ...
            *discriminator_block(128, 256),
            # *discriminator_block(256, 256), # try commenting out-only present in UP version
            nn.ZeroPad2d((1, 0, 1, 0)),
